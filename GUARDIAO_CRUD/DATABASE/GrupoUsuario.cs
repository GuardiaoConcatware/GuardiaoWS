...
{
    public class GrupoUsuario:DataBase
    {
        public GUARDIAO_STRUCTS.DATABASE.GrupoUsuario InsertNewGrupoUsuario(GUARDIAO_STRUCTS.DATABASE.GrupoUsuario grupoUsuario)
        {
            ...
            try
            {
                sql = "INSERT INTO tblGrupoUsuario";
        ...
        public GUARDIAO_STRUCTS.DATABASE.GrupoUsuario UpdateGrupoUsuario(GUARDIAO_STRUCTS.DATABASE.GrupoUsuario grupoUsuario)
        {
            ...
            try
            {
                sql = "UPDATE tblGrupoUsuario SET";
                sql += " grupoUsuario_descricao = ?";
        ...
        public List<GUARDIAO_STRUCTS.DATABASE.GrupoFuncionalidade> GetGrupoFuncionalidadeDisponivel(long grupoUsuario_id)
        {
            ...
            try
            {
                ...
                sql += " , tblItemFuncionalidade.itemFuncionalidade_id";
                sql += " , tblItemFuncionalidade.itemFuncionalidade_nome";
                sql += " FROM tblGrupoFuncionalidade";
                sql += " INNER JOIN tblItemFuncionalidade ON tblGrupoFuncionalidade.grupoFuncionalidade_id = tblItemFuncionalidade.grupoFuncionalidade_id";
                sql += " WHERE itemFuncionalidade_id NOT IN(";
                sql += " SELECT itemFuncionalidade_id";
                sql += " FROM tblGrupoUsuarioItem";
                sql += " WHERE grupoUsuario_id = " + grupoUsuario_id + ")";
        ...
        public List<GUARDIAO_STRUCTS.DATABASE.ItemFuncionalidade> GetItemFuncionalidadeByGrupoUsuarioByGrupoFuncionadade(long grupoUsuario_id, long grupoFuncionalidade_id)
        {
            ...
            try
            {
                sql = "SELECT tblItemFuncionalidade.itemFuncionalidade_id";            
                sql += " , tblItemFuncionalidade.grupoFuncionalidade_id";
                sql += " , tblItemFuncionalidade.itemFuncionalidade_nome COLLATE SQL_Latin1_General_Cp1251_CS_AS AS itemFuncionalidade_nome";
                sql += " FROM tblGrupoUsuarioItem";
                sql += " INNER JOIN tblItemFuncionalidade ON tblGrupoUsuarioItem.itemFuncionalidade_id = tblItemFuncionalidade.itemFuncionalidade_id";
                sql += " WHERE tblGrupoUsuarioItem.grupoUsuario_id = " + grupoUsuario_id;
                sql += " AND tblItemFuncionalidade.grupoFuncionalidade_id = " + grupoFuncionalidade_id;
        ...
        private List<GUARDIAO_STRUCTS.DATABASE.GrupoFuncionalidade> GetFuncionalidadesByGrupoUsuarioID(long grupoUsuario_id)
        {
            ...
            try
            {
                ...
                sql += " FROM tblGrupoUsuarioItem";
                sql += " INNER JOIN tblGrupoFuncionalidade ON tblGrupoUsuarioItem.grupoFuncionalidade_id = tblGrupoFuncionalidade.grupoFuncionalidade_id";
                sql += " WHERE tblGrupoUsuarioItem.grupoUsuario_id = " + grupoUsuario_id;
        ...
        private bool InsertItemGrupoFuncionalidadeGrupoUsuario(long grupoUsuario_id, long grupoFuncionalidade_id, long itemFuncionalidade_id)
        {
            ...
            try
            {
                sql = "INSERT INTO tblGrupoUsuarioItem";
                sql += " (grupoUsuario_id";
        ...
        private void DeleteAllFuncionadadesByGrupoUsuarioID(long grupoUsuario_id)
        {
            ...
            try
            {
                sql = "DELETE FROM tblGrupoUsuarioItem WHERE grupoUsuario_id = " + grupoUsuario_id;
                OpenDataBase();
                CM = new System.Data.OleDb.OleDbCommand(sql, CN);
                CM.ExecuteNonQuery();
            }
