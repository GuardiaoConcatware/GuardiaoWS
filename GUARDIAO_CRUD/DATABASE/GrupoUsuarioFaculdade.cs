...
namespace GUARDIAO_CRUD.DATABASE
{
    ...
    public class GrupoUsuarioFaculdade : DataBase
    {
        public GUARDIAO_STRUCTS.DATABASE.GrupoUsuario InsertNewGrupoUsuario(GUARDIAO_STRUCTS.DATABASE.GrupoUsuario grupoUsuario)
        {
            ...
            try
            {
                sql = "INSERT INTO tblGrupoUsuarioFaculdade";
            ...
            catch (Exception ex)
            {
                ...
                GUARDIAO_COMMOM.Error.CreateLogError(ex, System.Reflection.MethodBase.GetCurrentMethod().Name, typeof(GrupoUsuarioFaculdade).Namespace);
            }
            finally
            {
                CloseDataBase();
        ...
        public GUARDIAO_STRUCTS.DATABASE.GrupoUsuario UpdateGrupoUsuario(GUARDIAO_STRUCTS.DATABASE.GrupoUsuario grupoUsuario)
        {
            ...
            try
            {
                sql = "UPDATE tblGrupoUsuarioFaculdade SET";
                sql += " grupoUsuario_descricao = ?";
        ...
        public GUARDIAO_STRUCTS.DATABASE.GrupoUsuario GetGrupoUsuarioByID(long grupoUsuario_id)
        {
            ...
            try
            {
                ...
                sql += " ,grupoUsuario_descricao";
                sql += " FROM tblGrupoUsuarioFaculdade";
        ...
        public List<GUARDIAO_STRUCTS.DATABASE.GrupoFuncionalidade> GetGrupoFuncionalidadeDisponivel(long grupoUsuario_id)
        {
            ...
            try
            {
                sql = "SELECT tblGrupoFuncionalidade.grupoFuncionalidade_id";
                sql += " , tblGrupoFuncionalidade.grupoFuncionalidade_nome";
                sql += " , tblItemFuncionalidadeFaculdade.itemFuncionalidade_id";
                sql += " , tblItemFuncionalidadeFaculdade.itemFuncionalidade_nome";
                sql += " FROM tblGrupoFuncionalidade";
                sql += " INNER JOIN tblItemFuncionalidadeFaculdade ON tblGrupoFuncionalidade.grupoFuncionalidade_id = tblItemFuncionalidadeFaculdade.grupoFuncionalidade_id";
                sql += " WHERE itemFuncionalidade_id NOT IN(";
                sql += " SELECT itemFuncionalidade_id";
                sql += " FROM tblGrupoUsuarioFaculdadeItem";
                sql += " WHERE grupoUsuario_id = " + grupoUsuario_id + ")";
        ...
        public List<GUARDIAO_STRUCTS.DATABASE.ItemFuncionalidade> GetItemFuncionalidadeByGrupoUsuarioByGrupoFuncionadade(long grupoUsuario_id, long grupoFuncionalidade_id)
        {
            ...
            try
            {
                sql = "SELECT tblItemFuncionalidadeFaculdade.itemFuncionalidade_id";
                sql += " , tblItemFuncionalidadeFaculdade.grupoFuncionalidade_id";
                sql += " , tblItemFuncionalidadeFaculdade.itemFuncionalidade_nome COLLATE SQL_Latin1_General_Cp1251_CS_AS AS itemFuncionalidade_nome";
                sql += " FROM tblGrupoUsuarioFaculdadeItem";
                sql += " INNER JOIN tblItemFuncionalidadeFaculdade ON tblGrupoUsuarioFaculdadeItem.itemFuncionalidade_id = tblItemFuncionalidadeFaculdade.itemFuncionalidade_id";
                sql += " WHERE tblGrupoUsuarioFaculdadeItem.grupoUsuario_id = " + grupoUsuario_id;
                sql += " AND tblItemFuncionalidadeFaculdade.grupoFuncionalidade_id = " + grupoFuncionalidade_id;
        ...
        private List<GUARDIAO_STRUCTS.DATABASE.GrupoFuncionalidade> GetFuncionalidadesByGrupoUsuarioID(long grupoUsuario_id)
        {
            ...
            try
            {
                ...
                sql += " FROM tblGrupoUsuarioFaculdadeItem";
                sql += " INNER JOIN tblGrupoFuncionalidade ON tblGrupoUsuarioFaculdadeItem.grupoFuncionalidade_id = tblGrupoFuncionalidade.grupoFuncionalidade_id";
                sql += " WHERE tblGrupoUsuarioFaculdadeItem.grupoUsuario_id = " + grupoUsuario_id;
        ...
        private bool InsertItemGrupoFuncionalidadeGrupoUsuario(long grupoUsuario_id, long grupoFuncionalidade_id, long itemFuncionalidade_id)
        {
            ...
            try
            {
                sql = "INSERT INTO tblGrupoUsuarioFaculdadeItem";
                sql += " (grupoUsuario_id";
        ...
        private void DeleteAllFuncionadadesByGrupoUsuarioID(long grupoUsuario_id)
        {
            ...
            try
            {
                sql = "DELETE FROM tblGrupoUsuarioFaculdadeItem WHERE grupoUsuario_id = " + grupoUsuario_id;
                OpenDataBase();
                CM = new System.Data.OleDb.OleDbCommand(sql, CN);
                CM.ExecuteNonQuery();
            }
