...
namespace GUARDIAO_CONTROLLER.DATABASE
{
  public class Atendimentos
  {
    ...
    public string GetAtendimentosData()
    {
      List<GUARDIAO_STRUCTS.DATABASE.AtendimentoQuantidade> atendimentos = null;
      try
      {
        objAtendimentos = new GUARDIAO_CRUD.DATABASE.Atendimentos();
      ...
      catch (Exception ex)
      {
        if (atendimentos == null)
          GUARDIAO_COMMOM.Error.CreateLogError(ex, System.Reflection.MethodBase.GetCurrentMethod().Name, typeof(AtendimentoQuantidade).Namespace);
      }

      return JsonConvert.SerializeObject(atendimentos);
    }
     
    public string GetAtendimentosData(int idUsuario)
    {
      List<GUARDIAO_STRUCTS.DATABASE.AtendimentoQuantidade> atendimentos = null;
      try
      {
