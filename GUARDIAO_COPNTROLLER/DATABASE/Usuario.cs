...
namespace GUARDIAO_CONTROLLER.DATABASE
{
  public class Usuario
  {
    ...
    public string GetQuantidadeUsuarioData()
    {
      List<GUARDIAO_STRUCTS.DATABASE.UsuarioQuantidade> especialidade = null;
      try
      {
        objUsuario = new GUARDIAO_CRUD.DATABASE.Usuario();
        especialidade = objUsuario.GetQuantidadeUsuario();
      }
      catch (Exception ex)
      {
        if (especialidade == null)
          GUARDIAO_COMMOM.Error.CreateLogError(ex, System.Reflection.MethodBase.GetCurrentMethod().Name, typeof(UsuarioQuantidade).Namespace);
      }

      return JsonConvert.SerializeObject(especialidade);
    } 
    
    public string GetQuantidadeUsuarioData(int idUsuario)
    {
      List<GUARDIAO_STRUCTS.DATABASE.UsuarioQuantidadeAdvogado> especialidade = null;
      try
      {
        objUsuario = new GUARDIAO_CRUD.DATABASE.Usuario();
        especialidade = objUsuario.GetQuantidadeUsuario(idUsuario);
      }
      catch (Exception ex)
      {
        if (especialidade == null)
    ...
    public string ValidarLoginUsuario(long usuario_cpf, string usuario_senha)
    {
      ...
      {
        GUARDIAO_CRUD.DATABASE.Usuario objUsuario = new GUARDIAO_CRUD.DATABASE.Usuario();
        usuario = objUsuario.ValidarLoginUsuario(usuario_cpf, GUARDIAO_COMMOM.Crypto.DecryptSentence(usuario_senha), 1);
      }
      catch (Exception ex)
      {
        if (usuario == null)
    ...
    public string GetAllUsuarioAdvogadoAtivo()
    {
    ...
    public string GetAllUsuarioAdvogadoAtivo(int idUsuario)
    {
    ...
    public string AtivaUsuario(int idUsuario)
    {
      ...
      {
        objUsuario = new GUARDIAO_CRUD.DATABASE.Usuario();
        usuarioAtivado = objUsuario.AtivaUsuario(idUsuario);
